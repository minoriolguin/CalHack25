  ...
  return (
    <div className="p-6 m-6 bg-white rounded-xl shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
      ...
      {reservations.map((reservation, index) => (
        <div
          key={index}
          className="flex justify-between items-center p-4 mb-4 rounded-lg border border border-solid max-md:flex-col max-md:gap-3 max-md:items-start"
        >
          <div className="flex gap-4 items-center">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="text-sm text-black">{reservation.date}</div>
            </div>
          </div>
